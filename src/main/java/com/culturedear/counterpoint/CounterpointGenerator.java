...
public class CounterpointGenerator {
    ...
    public CounterpointGenerator(CounterpointProperties counterpointProperties) {
    ...
    */
        switch (mode) {
            case 0:
                return (_ionian[pit]); //ionian
            case 1:
                return (_dorian[pit]); //dorian
            case 2:
                return (_phrygian[pit]); //phrygian
            case 3:
                return (_lydian[pit]); //lydian
            case 4:
                return (_mixolydian[pit]); //mixolydian
            case 5:
                return (_aeolian[pit]); //aeolian
            case 6:
                return (_locrian[pit]); //locrian
        }
        return (false);
    }
    ...
    int size(int melInt) {
        ...
        switch (actInt) {
            ...
            case 2:
                intTyp = two;
                break; //minorSecond majorSecond
            case 3:
            case 4:
                intTyp = three;
                break; //minorThird majorThird
            case 5:
                intTyp = four;
                break; //fourth
            case 7:
  ...
  /* 0 = octave, 2 = step, 3 = third, 4 = fourth,
    ...
    /*  AllDone=1; */
        ...
        counterpointSolution = new CounterpointSolution(this.counterpointProperties);
